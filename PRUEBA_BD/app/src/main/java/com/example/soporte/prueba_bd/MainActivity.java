...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
        ...
        private static final String TAG = "MsgLogs";
    ...
    public void alta(View v) {
        ...
        String use = et1.getText().toString();
        String pas = et2.getText().toString();
        ContentValues registro = new ContentValues();
        registro.put("user", use);
        registro.put("password", pas);
        bd.insert("users", null, registro);
        bd.close();
        et1.setText("");
        et2.setText("");
        Toast.makeText(this, "Se creo una nueva cuenta",
    ...
    public void Ter(View v){
        ...
        Intent i = new Intent(this, Mobiles.class );
        startActivity(i);
    }
    ...
    /*public void Elect(View view) {
        ...
        if(button_text.equals("Electricidad")){
